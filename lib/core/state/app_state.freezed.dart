...
class _$AppStateImpl implements _AppState {
  ...
  @override
  String toString() {
    return 'AppState(isLoading: $isLoading, isAuthenticated: $isAuthenticated, currentUser: $currentUser, isOnline: $isOnline, lastError: $lastError)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState(
      ...
      final User? currentUser,
      final bool isOnline,
      final String? lastError}) = _$AppStateImpl;
...
class __$$SuccessImplCopyWithImpl<$Res>
    extends _$LoadingStateCopyWithImpl<$Res, _$SuccessImpl>
...
abstract class _Success implements LoadingState {
