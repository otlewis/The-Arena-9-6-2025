...
class ModeratorRegistrationScreen extends StatefulWidget {
  final String currentUserId;
  final ModeratorProfile? existingProfile;

  const ModeratorRegistrationScreen({
    super.key,
  ...
  @override
  State<ModeratorRegistrationScreen> createState() => _ModeratorRegistrationScreenState();
}

class _ModeratorRegistrationScreenState extends State<ModeratorRegistrationScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      final profileData = {
        ...
        'totalModerated': widget.existingProfile?.totalModerated ?? 0,
      ...
      if (widget.existingProfile != null) {
        ...
        _showSuccess('Moderator profile created successfully!');
      }
      ...
      AppLogger().debug('Error saving moderator profile: $e');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.existingProfile != null ? 'Edit Moderator Profile' : 'Become a Moderator'),
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    widget.existingProfile != null ? 'Update Your Moderator Profile' : 'Join as a Moderator',
                  ...
                  Text(
                    'Help facilitate fair and engaging debates in the Arena community',
                    style: TextStyle(
                      fontSize: 14,
            ...
            _buildSection(
              ...
              [
                Text(
                  'Select the categories you\'re comfortable moderating:',
                  style: TextStyle(
                    fontSize: 14,
            ...
            _buildSection(
              ...
              [
                SwitchListTile(
                  title: const Text('Available for moderation'),
                  subtitle: Text(
                    _isAvailable 
