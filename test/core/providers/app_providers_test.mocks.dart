...
// in arena/test/core/providers/app_providers_test.dart.
...
class _FakeLogger_9 extends _i1.SmartFake implements _i4.Logger {
  _FakeLogger_9(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockAppwriteService extends _i1.Mock implements _i5.AppwriteService {
  ...
  @override
  _i6.Future<String?> createPingRequest({
  ...
  @override
  _i6.Future<List<Map<String, dynamic>>> getPendingPingRequests(
          String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<bool> updatePingRequestStatus({
  ...
  @override
  _i6.Future<void> cleanupExpiredPingRequests() => (super.noSuchMethod(
        Invocation.method(
